...
public class JavaCollectionExample1 {
    public static void main(String[] args) {  
        ...
        Boolean val=set.contains(777);
        if (val){  
            System.out.println("777 is present in the collection");
        }  
        else{  
            System.out.println("777 is not present in the collection");
        }  
